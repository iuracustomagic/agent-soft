...
import {GetRequests, GetReturns, SendDeleteRequest, SendDeleteReturns} from "../API/api";
import {
...
export const CleanReturnScreen = ({navigation}) => {
    ...
    async function sendRequest(){
        ...
        const response = await SendDeleteReturns(token, date);
